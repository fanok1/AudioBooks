...
*/
    ...
    public static boolean isVPNConected(){
    ...
    public static void waitVpnConetion(){
        if(OpenVpnApi.startVpn){
            long a = System.currentTimeMillis();
            while (!VpnStatus.isVPNConected()){
            ...
            while (true){
                if((System.currentTimeMillis()-a)/1000>2){
                    return;
                }
            }
        }
